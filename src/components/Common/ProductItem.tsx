...
import { toggleChatBot } from "@/redux/features/chatBot-slice";
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        <Image src={item.imgs?.previews[0] || "/images/default.png"} alt={item.title} width={250} height={250} />
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            onClick={handleChatBotModel}
            aria-label="button for AI suggestions" 
            id="aiSuggestion"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-blue group"
          >
            <svg className="fill-current group-hover:fill-blue w-7 h-7" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
              <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <title>Chat Bot</title>
                <desc>Created with Sketch.</desc>
                <g id="🔍-Product-Icons" stroke="none" strokeWidth="1" fill="currentColor" fillRule="evenodd">
                  <g id="ic_fluent_bot_24_filled" fill="currentColor" fillRule="evenodd">

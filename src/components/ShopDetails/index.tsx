              ...
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                ...
                <div className="max-w-[539px] w-full">
                  ...
                  <h3 className="font-medium text-custom-1 mb-4.5">
                    <span className="text-sm sm:text-xl font-semibold text-dark">
                      Price: ${product.price}
                    </span>
                ...
                >
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">{product.brand_name}</p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    <div className="max-w-[450px] min-w-[140px] w-full">
                      <p className="text-sm sm:text-base text-dark">Processor</p>
                    </div>
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        {product.processor_brand} ({product.num_cores} cores, {product.processor_speed} GHz)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        {product.ram_capacity}GB RAM, {product.internal_memory}GB Storage
                        {product.extended_memory_available ? ` (Expandable up to ${product.extended_upto}GB)` : ''}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        {product.primary_camera_rear}MP ({product.num_rear_cameras} cameras)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        {product.primary_camera_front}MP
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        ...
                        {product.fast_charging_available ? `, ${product.fast_charging}W Fast Charging` : ''}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        {[
                          product.has_5g && '5G',
                          product.has_nfc && 'NFC',
                          product.has_ir_blaster && 'IR Blaster'
                        ].filter(Boolean).join(', ')}
                      </p>
                    </div>
                  </div>
